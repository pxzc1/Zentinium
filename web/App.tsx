...
const Logo = ({ className = "w-8 h-8" }: { className?: string }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M398.991 427.386c4.955 0 9.412 0 14.726 0-1.266-1.59-1.94-2.617-2.787-3.473-4.219-4.264-9.041-8.064-12.614-12.808-7.404-9.832-16.604-12.903-28.853-12.155-17.933 1.094-35.983.277-53.983.275-1.8 0-3.601 0-6.837 0 8.458-8.368 15.937-15.852 23.56-23.186.793-.763 2.439-.886 3.69-.9 19.167-.056 38.334-.09 57.499.04 1.604.01 3.637.811 4.736 1.952 23.224 24.12 46.344 48.34 69.468 72.555.309.322.42.833.8 1.623-95.413 0-190.555 0-285.523 0 70.175-70.723 140.28-141.375 210.787-212.433-2.23 0-4.445 0-6.66 0-54.999 0-110 0-164.999-.126-2.198-.005-5.043-.825-6.493-2.323-22.818-23.588-45.457-47.349-68.129-71.079-.66-.692-1.223-1.477-2.241-2.72 95.09 0 189.575 0 285.152 0-8.143 8.111-15.552 15.66-23.22 22.937-1.085 1.03-3.43 1.006-5.192 1.007-65.166.036-130.332.018-195.498.007-1.758 0-3.517 0-5.276 0-.27 1.157-.541 1.625-.811 2.093 5.807 5.582 12.199 10.684 17.276 16.866 6.503 7.917 14.005 10.212 24.189 10.142 68.83-.473 137.665-.248 206.498-.249 1.806 0 3.613 0 4.989 0-69.998 70.586-140.038 141.214-210.838 212.608 52.424 0 104.255 0 156.584 0z"
    />
    <path
      fill="currentColor"
      d="M188.154 370.153c33.378-33.296 66.515-66.335 99.558-99.467 2.643-2.65 5.266-3.956 9.114-3.849 9.81.274 19.633.091 30.389.091-1.493 1.691-2.44 2.891-3.515 3.963-41.865 41.766-83.716 83.546-125.707 125.185-1.745 1.731-4.784 2.93-7.266 3.012-10.105.335-20.228.14-31.104-.98 9.421-9.24 18.843-18.48 28.531-27.955z"
    />
  </svg>
);
